...
public class AsfMgrLog {
    ...
    public static void initLog() {
        ...
        AsfMgrLog.HistoryDateFileNameGenerator fileNameGenerator = new AsfMgrLog.HistoryDateFileNameGenerator(3, Constants.LOG_DIR);
        Printer filePrinter = new FilePrinter                                   // 打印日志到文件的打印器
                .Builder(Constants.LOG_DIR)                                     // 指定保存日志文件的路径
